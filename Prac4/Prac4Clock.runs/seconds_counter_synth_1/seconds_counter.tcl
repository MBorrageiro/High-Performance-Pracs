...
set cached_ip [config_ip_cache -export -no_bom  -dir {D:/UCT Work/EEE/High Perfomance Embedded/FPGA/Prac4/Prac4Clock.runs/seconds_counter_synth_1} -new_name seconds_counter -ip [get_ips seconds_counter]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top seconds_counter -part xc7a100tcsg324-2 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix seconds_counter_ seconds_counter.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ seconds_counter_stub.v
 lappend ipCachedFiles seconds_counter_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ seconds_counter_stub.vhdl
 lappend ipCachedFiles seconds_counter_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ seconds_counter_sim_netlist.v
 lappend ipCachedFiles seconds_counter_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ seconds_counter_sim_netlist.vhdl
 lappend ipCachedFiles seconds_counter_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp seconds_counter.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips seconds_counter]
}

rename_ref -prefix_all seconds_counter_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef seconds_counter.dcp
